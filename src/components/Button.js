...
function Button({
  ...
  const classes = className(rest.className,
    `flex items-center my-1 px-3 py-1.5 border transition ease-in duration-75
    hover:opacity-80 shadow-xl hover:shadow-md hover:-translate-y-1 hover:scale-105`,
    {
